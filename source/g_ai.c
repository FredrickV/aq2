...
// g_ai.c
//
// $Id: g_ai.c,v 1.3 2001/09/28 13:48:34 ra Exp $
//
//-----------------------------------------------------------------------------
// $Log: g_ai.c,v $
...
visible (edict_t * self, edict_t * other)
{
  ...
  trace =
    gi.trace (spot1, vec3_origin, vec3_origin, spot2, self, MASK_OPAQUE);
  ...
  if (self->enemy->health > 0)
    {
      ...
      tr =
	gi.trace (spot1, NULL, NULL, spot2, self,
...
//              gi.dprintf("checking for course correction\n");
      ...
      tr =
	gi.trace (self->s.origin, self->mins, self->maxs,
